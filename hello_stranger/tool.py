...
@tool
def modify_characteristics(operator: Literal["+", "-"], characteristic: str, characteristics: Annotated[list, InjectedState("characteristics")]) -> list[str]:
...
@tool
def notify_dependents(email_subject: str, email_body: str, messages: Annotated[list, InjectedState("messages")]):
